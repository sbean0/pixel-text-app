...
function setupDragAndDrop() {
    ...
    containers.forEach(container => {
        container.addEventListener('dragover', e => {
            ...
            if (draggedElement) { // Check if draggedElement exists
        ...
        container.addEventListener('drop', e => {
            ...
            if (container.id === 'activeFonts') {
                ...
                if (font && existingFonts && !existingFonts.includes(font)) { // Check if font and existingFonts are valid
                    const fontItem = document.createElement('div');
                    fontItem.className = 'font-item';
                    fontItem.draggable = true;
                    fontItem.textContent = font;
...
function generateText() {
    ...
    // Use [AMPERSAND] as a placeholder for the & character
...
function addFontToAvailableBox(font) {
    ...
    if (font && existingFonts && !existingFonts.includes(font)) {
        const fontItem = document.createElement('div');
        fontItem.className = 'font-item';
        fontItem.draggable = true;
        fontItem.textContent = font;
